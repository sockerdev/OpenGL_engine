# Install script for directory: /Users/ihorfarion/Developer/OpenGL/assimp-5.0.1/tools/assimp_cmd
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xassimp-binx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/Users/ihorfarion/Developer/OpenGL/assimp-5.0.1/bin/assimp")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      -delete_rpath "/Users/ihorfarion/Developer/OpenGL/assimp-5.0.1"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp")
    execute_process(COMMAND /usr/bin/install_name_tool
